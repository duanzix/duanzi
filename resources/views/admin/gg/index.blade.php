                    ...
                    <table class="am-table am-table-striped am-table-hover table-main">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$v['id']}}</td>
                                <td>{{$v['url']}}</td>
                                <td><img src="{{$v['image']}}" width="80px"></td>
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <form action="" method="get">

                                            <a style="float:left" href="/gg/{{$v['id']}}/edit" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                        </form>
                                            
                                        </div>
                                        <form style="float:left" action="/gg/{{$v['id']}}" method="post">
